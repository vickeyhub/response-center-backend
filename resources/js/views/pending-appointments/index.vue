<template>
    <section class="section-content bg-white col p-4">
        ...
        <div class="content-wrap pt-4">
            <div class="row mb-3 g-3 flex-sm-row-reverse align-items-center">
                <div class="col-sm-auto">
                    <div class="data-search">
                        <input type="text" v-model="searchQuery" v-on:input="debouncedGetData"
                            class="form-control form-control-sm" placeholder="Search by Name, Email or Ref No." />
                    </div>
                </div>
                <div class="col-sm-auto">
                    <div class="">
                        <select v-model="filterQuery" @change="getData()" name="" id="" class="form-select form-control">
            ...
            <List :appointments="appointments" :totalCount="totalPages" type="pending" @changePage="getData" />
        </div>
    </section>
</template>
