                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top" style="font-size:14px;line-height: 22px; font-family:Arial; color:#000; padding-top:15px;">
                                                                Thank you for registering with us, Your login id and password are given below:
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top" style="font-size:14px; font-family:Arial; color:#000;">
                                                                ...
                                                                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                                    <tr>
                                                                        <td align="left" style="font-size:14px;line-height: 26px; font-family:Arial; color:#000; font-weight:bold;">Username: <span style="color:#3A89C9">{{$email}}</span></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="left" style="font-size:14px;line-height: 26px; font-family:Arial; color:#000; font-weight:bold;">
                                                                            Password: <span style="color:#3A89C9">{{$password}}</span></td>
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top" style="font-size:14px;line-height: 22px; font-family:Arial; color:#000; padding-top:5px;">
                                                                If unable to login via these credentials. <br>Please contact us at <a href="/managemailto:info@responsivecenters.com" style="color:#3A89C9">info@responsivecenters.com</a>
                                                            </td>
                                                        </tr>
                                                        <tr>
